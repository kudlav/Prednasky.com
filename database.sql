...
CREATE TABLE IF NOT EXISTS `prednasky`.`video` (
  ...
  `duration` INT NULL,
  `abstract` TEXT NULL,
  `plane_points` VARCHAR(100) NULL,
  `plane_width` VARCHAR(10) NULL,
...
START TRANSACTION;
USE `prednasky`;
INSERT INTO `prednasky`.`video_state` (`id`, `name`) VALUES (DEFAULT, 'created');
INSERT INTO `prednasky`.`video_state` (`id`, `name`) VALUES (DEFAULT, 'processing');
INSERT INTO `prednasky`.`video_state` (`id`, `name`) VALUES (DEFAULT, 'done_private');
INSERT INTO `prednasky`.`video_state` (`id`, `name`) VALUES (DEFAULT, 'done_logged_in');
INSERT INTO `prednasky`.`video_state` (`id`, `name`) VALUES (DEFAULT, 'done_public');
